          ...
          <div class="progress-content">
            ...
            <div class="progress default">
              <div
                ...
                style="width: 60%"
              >
                <span class="progress-label">Default</span>60%
              </div>
            </div>
            <div class="progress default">
              <div
                ...
                style="width: 40%"
              >
                <span class="progress-label">Success</span>40%
              </div>
            </div>
            <div class="progress default">
              <div
                ...
                style="width: 20%"
              >
                <span class="progress-label">Info</span>20%
              </div>
            </div>
            <div class="progress default">
              <div
                ...
                style="width: 60%"
              >
                <span class="progress-label">Warning</span>60%
              </div>
            </div>
            <div class="progress default">
              <div
                ...
                style="width: 80%"
              >
                <span class="progress-label">Danger</span>80%
              </div>
            </div>
            ...
            <div class="progress progress-striped active">
              <div
                ...
                style="width: 80%"
              >
                <span class="progress-label"></span>80%
              </div>
            </div>
          </div>
