                  ...
                  <div class="tab_grid">
                    <div class="jobs-item with-thumb">
                      ...
                      <div class="jobs_right">
                        ...
                        <div class="date_desc">
                          <h6 class="title">
                            <a href="jobs_single.php">Front-end Developer</a>
                          </h6>
                        ...
                        <p class="description">
                          ...
                          elit. Suscipit, maxime, excepturi, mollitia,
                          voluptatibus similique aliquid a dolores autem
                          laudantium sapiente ad enim ipsa modi laborum
                          accusantium deleniti neque architecto vitae.
                          <a href="jobs_single.php" class="read-more"
                            >Read More</a
                          >
                        </p>
                      </div>
            ...
            <table class="table">
              <tbody>
                <tr class="unread checked">
                  ...
                  <td class="hidden-xs">Full time</td>
                </tr>
                <tr class="unread checked">
                  <td class="hidden-xs">
                    <input type="checkbox" class="checkbox" />
                  </td>
                  <td class="hidden-xs">Parttime</td>
                </tr>
              </tbody>
            </table>
          </div>
